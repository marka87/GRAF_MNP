...
void Z_Axis_ReferenceRun(ad5684_dac_t *dac, bool* success)
{
    ...
    *success = true;
    ...
    ad5684_set_voltage(dac, 2.1f, z_mot);
    HAL_Delay(100);
...
//
//
//	uint16_t nadel_oben; 	//ADC Position Nadel Oben
//	uint16_t z_ax_no_pos = 0; //Encoder Position Z-Achse, beim erreichen der Nadel Oben Position
...
//        ad5684_set_voltage(dac, 2.35f, z_mot); // Langsamer fahren
